 ...
 * the {@link MetalogObserver} instance.
 */
@CompileStatic
class MetalogFactory implements TraceObserverFactoryV2 {
    ...
    Collection<TraceObserverV2> create(Session session) {
        ...
        return List.<TraceObserverV2>of(new MetalogObserver(session, config))
    }
